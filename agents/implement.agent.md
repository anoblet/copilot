...
Follow the global [instructions](../../.github/copilot-instructions.md), applying SOLID, DRY, YAGNI, and MVC principles pragmatically and using sequential thinking for multi-step changes.
